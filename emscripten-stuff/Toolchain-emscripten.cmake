...
SET(CMAKE_C_LINK_EXECUTABLE "llvm-link -o <TARGET> <LINK_FLAGS> <OBJECTS>")
SET(CMAKE_CXX_LINK_EXECUTABLE ${CMAKE_C_LINK_EXECUTABLE})
SET(CMAKE_CXX_CREATE_SHARED_LIBRARY ${CMAKE_C_LINK_EXECUTABLE})
set(CMAKE_CXX_FLAGS "-emit-llvm -nostdinc++ -nostdinc -Qunused-arguments -fcolor-diagnostics -m32 -O0 -isystem${EMSCRIPTEN_SYSTEM}/include -isystem${EMSCRIPTEN_SYSTEM}/include/bsd -isystem${EMSCRIPTEN_SYSTEM}/include/libcxx -isystem${EMSCRIPTEN_SYSTEM}/include/libc -isystem${EMSCRIPTEN_SYSTEM}/include/sys -isystem${EMSCRIPTEN_SYSTEM}/include/net -isystem${EMSCRIPTEN_SYSTEM}/lib/libcxxabi/include/" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS "-emit-llvm -nostdinc -Qunused-arguments -fcolor-diagnostics -m32 -isystem${EMSCRIPTEN_SYSTEM}/include -isystem${EMSCRIPTEN_SYSTEM}/include/bsd -isystem${EMSCRIPTEN_SYSTEM}/include/libcxx -isystem${EMSCRIPTEN_SYSTEM}/include/libc -isystem${EMSCRIPTEN_SYSTEM}/include/sys " CACHE STRING "" FORCE)
